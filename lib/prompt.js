...
13. **ASLA İSİM VE MARKA ADI KULLANMA**: Hiçbir koşulda kişi adı (Gizem, Gizem Hanım, Gizem Şule Mert vb.) veya marka adı (Astroşuşu, astrosusu vb.) söyleme. Kendinizi tanıtmayın, "ben şuyum/buyum" demeyin. Müşteriye sadece "siz/sizin" diye hitap edin. Metinde herhangi bir özel isim, marka, kurum, ürün adı GEÇMESİN. Sadece sayı, arkana adı, sembolik kavramlar, yaş dönemleri ve karmik yorumlar olsun.
...
**MAKSİMUM 950 KELİME**. Tek bir kelime daha fazla yazma. 850-950 kelime aralığı idealdir. Bunun üstüne çıkarsan metnin teknik olarak kesilir ve yarım kalır — bu felakettir. Bu nedenle:
- Her paragrafı kısa tut (3-5 cümle)
- Her temayı tek paragrafta toparla
- Sayı yorumlarını sıkıştır, en kritik 4-5 sayıya odaklan, tüm 13 sayıyı tek tek anlatma
- Soy karması, ritüeller, sağlık temaları, yaş döngüleri — her birine sadece 2-3 cümle
- Akıcı kal ama özlü
- Doğal kapanış cümlesiyle bitir; sözünü tamamla
- Sayıları gereksiz tekrar etme; bir kez bağlamla anlat, geç
...
export function buildUserPrompt(birthDate, matrixResults) {
  ...
  lines.push('');
  lines.push(`Lütfen bu sayıları bütüncül analiz eden, 2. tekil şahısa hitap eden, akıcı paragraflarla yazılmış, **MAKSİMUM 950 KELİMELİK** özlü bir karmik özet yaz. 950 kelimeyi ASLA aşma — aşarsan metnin yarım kalır. İdeal hedef 850-900 kelime. Kişiye doğrudan "sizde", "sizin" diye hitap et. En kritik 4-5 sayıya odaklan; geri kalanlara kısaca değin. Soy karması, ritüeller, sağlık temaları ve yaş döngülerine her birine sadece birkaç cümle ayır. Hiçbir başlık veya madde listesi kullanma. Hiçbir kişi adı veya marka adı geçirme. Doğal bir kapanış cümlesiyle bitir; metin yarım kalmasın.`);
...
// NOT: Vercel Hobby tier 60s timeout'u için sadece en kısa örnek
// (08.08.1970, ~1000 kelime) kullanılır. Bu, Claude'u kısa
// çıktı üretmeye anchor'lar.
// ============================================================
export function buildFewShotMessages() {
  const messages = [];
  const limited = EXAMPLE_ANALYSES.filter(e => e.birthDate === '08.08.1970');
